...
function splitCommandHelper(cmd, recordCmd, keepEnd, debug) {
  ...
  } //     hgetall room:game:status:444555
  // hgetall game:status:1:444555
  // get effect:room_user_info:444555:1233
  // ttl room:game:status:444555
  // ttl game:status:1:444555
  // ttl effect:room_user_info:444555:1233
  // c could be ;, \n, or null(the end)
...
function parseCommands(cmdStr, keepCommand, keepEnd) {
  if (!keepCommand) {
