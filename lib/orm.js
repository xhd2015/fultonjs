...
class ORM {
  ...
  insertOrUpdateMany(tx, key, data, idField, ids, options) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      const result = items.map(({
        ...
        conditions,
        args
      }, idx) => __awaiter(this, void 0, void 0, function* () {
        return yield this._doInsertOrUpdate(tx, idField, model, conditions, args, ids[idx], createPreset, updatePreset, {
          keepNull
        });
      }));
  ...
  count(where) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      const data = yield this.findOne(where, {
        fields: "COUNT(*)"
      });
