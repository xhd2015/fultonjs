...
exports.trasferCode = trasferCode;
exports.traverseAst = traverseAst;

var _babel = _interopRequireDefault(require("@babel/standalone/babel"));
...
let Babel = _babel.default; // not browser?

if (typeof window === 'undefined') {
  // use server side babel/core
  Babel = require("@babel/core");
} else {
  Babel = _babel.default || window.Babel;
}
...
function loadCode(______, _______) {
  ...
  if (______) {
    return eval(trasferCode('(' + ______ + ")", { ..._______,
