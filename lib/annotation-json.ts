...
type Annotation = { [key: string | symbol]: any } | any
...
class Stringifer {
    ...
    _annotationKey: string | symbol;
    _preserveUndefined: boolean;
    _pretty: boolean
    _indent: string
    _object: any
    _level: number
    _curAnnotation: Annotation;
    // options
    //  
    constructor(object: any, options: StringifyOptions) {
