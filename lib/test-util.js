...
const path = require("path"); // const tests = { testShouldNotCacheNull }
...
function readFile(dirname, file) {
  return __awaiter(this, void 0, void 0, function* () {
    return yield fs.promises.readFile(path.resolve(dirname, file), {
      encoding: 'utf-8'
    });
  });
}

function readFileSync(dirname, file) {
  return fs.readFileSync(path.resolve(dirname, file), {
    encoding: 'utf-8'
  });
}