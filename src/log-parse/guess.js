...
export function tryParseReqOption(s) {
    if (!s) {
        return null;
    }
...
//  3. count how many 
export function guessOptions(s) {
    if (!s) {
        return [];
    }
    const opts = [];
...
export function tryExtractAll(s, opts) {
    const details = tryExtractAllWithDetail(s);
    return details.map(e => e.object);
}
export function tryExtractAllWithDetail(s, opts) {
    var _a;
    if (!s) {
        return [];
    }
...
export function tryExtractByLookingPrefix(s) {
    return [];
}
// this strategy simple locate to some prefix, and do a strict parse
export function tryExtractByStartingFromKV(s) {
