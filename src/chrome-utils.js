...
export function querySelectorAll(...queries) {
...
export function querySelectorAllOn(el, ...queries) {
    if (queries.length === 0) {
        return undefined
    }
...
export function querySelectorOn(el, ...queries) {
...
// total time: 1h
export async function until(fn, limit, interval = 1000) {
    if (interval <= 0) {
