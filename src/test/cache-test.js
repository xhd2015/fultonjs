...
async function testSmoke() {
    const cacher = new AsyncCacher(async (args) => {
    ...
    const v1 = await cacher.get({ t: 1 })
    console.log("v1:", v1)
    const v2 = await cacher.get({ t: 2 })
    console.log("v2:", v2)
